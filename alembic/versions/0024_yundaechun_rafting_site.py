"""Add the Yundaechun rafting official site."""

from alembic import op
from sqlalchemy import text

revision = "0024_yundaechun_rafting_site"
down_revision = "0023_remove_kwandong_hockey_center"
branch_labels = None
depends_on = None

EXTERNAL_ID = "131963"
OFFICIAL_URL = "http://www.yundaechun.com/"
